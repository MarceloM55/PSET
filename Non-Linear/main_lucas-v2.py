...
PGD  = {(t, s, c, a): model.addVar(name=f"PGD_{t}_{c}_{a}", lb=0, ub=par['MaxGD'])         for t in Ωt for s in Ωs for c in Ωc for a in Ωa}
...
γAEc = {(t, s, c, a): model.addVar(vtype=GRB.BINARY, name=f"AECharge{a}")      for t in Ωt for s in Ωs for c in Ωc for a in Ωa} 
γAEd = {(t, s, c, a): model.addVar(vtype=GRB.BINARY, name=f"AEDischarge{a}")   for t in Ωt for s in Ωs for c in Ωc for a in Ωa} 

PEVc = {(t, s, c, a): model.addVar(name=f"PAEi_{t}_{c}_{a}", lb=0)             for t in Ωt for s in Ωs for c in Ωc for a in Ωa}
PEVd = {(t, s, c, a): model.addVar(name=f"PAEe_{t}_{c}_{a}", lb=0)             for t in Ωt for s in Ωs for c in Ωc for a in Ωa}
...
γEVc = {(t, s, c, a): model.addVar(vtype=GRB.BINARY, name=f"EVCharge{a}")    for t in Ωt for s in Ωs for c in Ωc for a in Ωa} 
γEVd = {(t, s, c, a): model.addVar(vtype=GRB.BINARY, name=f"EVDischarge{a}") for t in Ωt for s in Ωs for c in Ωc for a in Ωa} 
...
PGD_values  = {(t, s, c, a): PGD[t, c, a].x for t in Ωt for c in Ωc for a in Ωa}
xD_values   = {(t, s, c, a): xD[t, s, c, a].x for t in Ωt for s in Ωs for c in Ωc for a in Ωa}

PEVc_values = {(t, s, c, a): PEVc[t, c, a].x for t in Ωt for c in Ωc for a in Ωa}
PEVd_values = {(t, s, c, a): PEVd[t, c, a].x for t in Ωt for c in Ωc for a in Ωa}
SoCEV_values  = {(t, s, c, a): SoCEV[t, c, a].x for t in Ωt for c in Ωc for a in Ωa}


PAEc_values = {(t, s, c, a): PAEc[t, c, a].x for t in Ωt for c in Ωc for a in Ωa}
PAEd_values = {(t, s, c, a): PAEd[t, c, a].x for t in Ωt for c in Ωc for a in Ωa}
EAE_values  = {(t, s, c, a): EAE[t, c, a].x for t in Ωt for c in Ωc for a in Ωa}
